...
$i                      = 1;
$adminmenu[$i]['title'] = _MD_CONVERT_ADMINMENU_HOME;
$adminmenu[$i]['link']  = 'admin/index.php';
$adminmenu[$i]['icon']  = $pathIcon32 . '/home.png';
++$i;
$adminmenu[$i]['title'] = _MD_CONVERT_ADMINMENU_FONTS;
$adminmenu[$i]['link']  = 'admin/fonts.php';
$adminmenu[$i]['icon']  = $pathIcon32 . '/download.png';
++$i;
$adminmenu[$i]['title'] = _MD_CONVERT_ADMINMENU_ABOUT;
